...
def trajectory_planner5(end_coord_list,waypoint_array,X_init,Y_init,phi_init,L,Ts,N):
  ...
  distance_right = np.linalg.norm(closest_midpoint2-end_coord_list[3])
  delta_distance = distance_left - distance_right
  ...
  steering_angle = math.acos(dot_product)
  vx = 3
